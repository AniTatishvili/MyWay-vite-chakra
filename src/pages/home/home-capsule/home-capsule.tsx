...
export const HomeCapsule = () => {
  ...
  return (
    <PageSectionContent>
      ...
      <Flex flexDir={"row"} justify={"space-between"} flexWrap={"wrap"} m={"2rem 0 4rem"} gap={10}>
        {capsuleItemsArr.map((item) => {
          return (
            <Flex key={item.id} flexDir={"column"} alignItems={"center"} gap={6}>
              <Flex flexDir={"column"}>
                <Box w={"400px"} h={"285px"} bg={"#fff"} borderRadius={"4px"} boxShadow={"1px 0 6px 1px rgba(0,0,0,.16);"} p={3}>
