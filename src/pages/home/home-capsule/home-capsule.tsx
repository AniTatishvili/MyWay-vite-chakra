...
export const HomeCapsule = () => {
  ...
  return (
    <PageSectionContent>
      ...
      <Flex flexDir={"row"} gap={10}  m={"2rem 0 4rem"}>
          ...
          return(
            <Flex key={item.id} flexDir={"column"} alignItems={"center"} gap={6}>
              <Flex flexDir={"column"}>
                ...
                <Box as="span" fontSize={"26px"} p={4}>Capsule</Box>
              </Flex>
              <Flex w={"100%"} flexDir={"row"} justify={"space-between"} align={"center"}>
                <Flex flexDir={"column"} alignItems={"center"} gap={2}>
                  ...
                  <Box as="p" fontSize={"16px"} p={4}>Up to 12 people</Box>
                </Flex>
                <Flex flexDir={"column"} alignItems={"center"} gap={2}>
                  <Image src={shower} alt="shower_image" w={"40px"}/>
                  <Box as="p" fontSize={"16px"} p={4}>Shared bathroom</Box>
                </Flex>
              </Flex>
