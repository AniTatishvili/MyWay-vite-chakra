    ...
    <>
        <PageSectionContent>
            <Flex flexDir={"column"}>
                ...
                <Box as="span" fontSize={{base:"14px", md: "18px"}}>{t("SERVICES.DESC")}</Box>
            </Flex>
            <Flex flexDir={"row"} flexWrap={"wrap"} justify={"space-between"} my={{base: 10, md: 16}} gap={4}>
                <Flex flexDir={"column"} gap={4}>
                    <Image src={sleep} alt="service"/>
                    <Box as="h3" color={"#745C26"} fontSize={{base:"22px", md: "30px"}} fontWeight={600}>{t("SERVICES.ITEMS.SLEEP")}</Box>
                </Flex>
                <Flex flexDir={"column"} gap={4}>
                    <Image src={eat} alt="service"/>
                    <Box as="h3" color={"#745C26"} fontSize={{base:"22px", md: "30px"}} fontWeight={600}>{t("SERVICES.ITEMS.EAT")}</Box>
                </Flex>
                <Flex flexDir={"column"} gap={4}>
                    <Image src={drink} alt="service"/>
                    <Box as="h3" color={"#745C26"} fontSize={{base:"22px", md: "30px"}} fontWeight={600}>{t("SERVICES.ITEMS.DRINK")}</Box>
                </Flex>
                <Flex flexDir={"column"} gap={4}>
                    <Image src={enjoy} alt="service"/>
                    <Box as="h3" color={"#745C26"} fontSize={{base:"22px", md: "30px"}} fontWeight={600}>{t("SERVICES.ITEMS.ENJOY")}</Box>
                </Flex>
            </Flex>
        </PageSectionContent>
    </>
